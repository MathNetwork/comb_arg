...
which the core theorem turns into the sup-reducing $f'$. For
comparison, we quote the DLT passage in which the packaging and
the final arithmetic live side by side.
