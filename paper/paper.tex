...
% Clickable Lean declaration tags.
% Syntax:  \lean{short_name}{file_path.lean}    — inline in prose.
%          \leanrefs{\leanitem{short_name}{file_path.lean} ...}  — indented list under theorem header.
% Only the short decl name is shown; the full GitHub URL is implicit
% via `\leanrepo`.
\definecolor{leantag}{HTML}{2B6CB0}
\newcommand{\lean}[2]{\href{\leanrepo/#2}{\color{leantag}\texttt{#1}}}
\newcommand{\leanrefs}[1]{%
  \par\nopagebreak
  \begingroup
  \begin{list}{}{\leftmargin=2em \topsep=2pt \itemsep=0pt \parsep=0pt}%
  #1
  \end{list}
  \endgroup
}
\newcommand{\leanitem}[2]{\item \href{\leanrepo/#2}{\color{leantag}\texttt{#1}}}
...
\label{def:pcover}
\leanrefs{\leanitem{PairableCover}{Witness.lean}}
...
\label{def:witness}
\leanrefs{\leanitem{LocalWitness}{Witness.lean}}
...
\label{def:NC}
\leanrefs{\leanitem{nearCritical}{Refinement/InitialCover.lean}}
...
\label{def:ref}
\leanrefs{\leanitem{FiniteCoverWithWitnesses}{Core.lean}}
...
\label{def:ic}
\leanrefs{\leanitem{InitialCover}{Refinement/InitialCover.lean}}
...
\label{def:pr}
\leanrefs{\leanitem{PartialRefinement}{Refinement/PartialRefinement.lean}}
...
\label{thm:core}
\leanrefs{\leanitem{exists\_sup\_reduction\_of\_cover}{Core.lean}}
\noindent
...
\label{thm:main}
\leanrefs{\leanitem{exists\_sup\_reduction}{SupReduction.lean}}
\noindent
...
\leanrefs{%
  \leanitem{isCompact\_nearCritical}{Refinement/InitialCover.lean}%
  \leanitem{nearCritical\_nonempty}{Refinement/InitialCover.lean}%
}
...
\leanrefs{\leanitem{exists\_initialCover}{Refinement/CoverConstruction.lean}}
...
\label{def:step0}
\leanrefs{\leanitem{step\_zero}{Refinement/PartialRefinement.lean}}
...
\label{def:step-succ}
\leanrefs{\leanitem{step\_succ\_at}{Refinement/Induction.lean}}
...
\leanrefs{\leanitem{exists\_terminal\_refinement}{Refinement/Induction.lean}}
...
\label{prop:twofold}
\leanrefs{\leanitem{terminal\_twoFold}{Refinement/Assembly.lean}}
...
\leanrefs{\leanitem{saving\_bound\_closure}{Refinement/Assembly.lean}}
...
\label{lem:assembly}
\leanrefs{\leanitem{exists\_refinement}{Refinement/Assembly.lean}}
