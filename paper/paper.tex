...
Lemma~3.1 supplies, for each near-critical parameter $t$, an
$\mathcal{H}^n$-disjoint pair of open sets
...
(a) and (b) transcribe DLT's spacing and subset conditions.}
\end{definition}
...
DLT start by applying Lemma~3.1 to produce, at each
