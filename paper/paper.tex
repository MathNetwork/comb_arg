...
% Clickable Lean declaration tags — Lean-logo purple, inline.
\definecolor{leanpurple}{HTML}{6F2DA8}
% Inline clickable tag.
%   \lean{short_name}{File/Path.lean}
\newcommand{\lean}[2]{\href{\leanrepo/#2}{\color{leanpurple}\texttt{#1}}}
% Header tag: small right-flushed bracketed name on its own line,
% rendered right after the theorem/def/prop label.
%   \leanmargin{short_name}{File/Path.lean}
\newcommand{\leanmargin}[2]{%
  \nopagebreak\hfill{\small\color{leanpurple}%
    [\href{\leanrepo/#2}{\texttt{#1}}]}\par\nopagebreak
}
% Two-decl header tag, comma-separated on one line.
\newcommand{\leanmargintwo}[4]{%
  \nopagebreak\hfill{\small\color{leanpurple}%
    [\href{\leanrepo/#2}{\texttt{#1}},
     \href{\leanrepo/#4}{\texttt{#3}}]}\par\nopagebreak
}
