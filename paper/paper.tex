...
% Header tag: appears on its own line directly under the
% theorem/def/prop heading, right-flushed. Consistent visual
% position regardless of heading length.
%   \leanmargin{short_name}{File/Path.lean}
\newcommand{\leanmargin}[2]{%
  \nopagebreak\mbox{}\hfill{\normalfont\small\color{leangreen}%
    [\ensuremath{\checkmark}\,\href{\leanrepo/#2}{\texttt{#1}}]}%
  \par\nopagebreak\vspace{-0.3\baselineskip}%
  \noindent\ignorespaces
}
% Two-decl header tag on its own line.
\newcommand{\leanmargintwo}[4]{%
  \nopagebreak\mbox{}\hfill{\normalfont\small\color{leangreen}%
    [\ensuremath{\checkmark}\,\href{\leanrepo/#2}{\texttt{#1}},
     \ensuremath{\checkmark}\,\href{\leanrepo/#4}{\texttt{#3}}]}%
  \par\nopagebreak\vspace{-0.3\baselineskip}%
  \noindent\ignorespaces
}
