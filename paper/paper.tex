...
Theorem~\ref{thm:intro-scalar} reappears in
\S\ref{sec:app-spec} as the public one-parameter API of \CombArg\
(Theorem~\ref{thm:main}); it is the specialization of an abstract
core (Theorem~\ref{thm:core}) in which the pair $(1/N, 1/(4N))$
becomes arbitrary scalars $(\delta, \varepsilon)$ with
$\varepsilon \le \delta$.

\paragraph{Scope.} This note formalizes the proof of the Claim
...
In DLT's proof of Proposition~\ref{prop:AP-combinatorial},
