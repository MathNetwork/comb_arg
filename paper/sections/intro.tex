...
verified by \texttt{lake build}: a build of
\texttt{CombArg.Scalar.Partition} compiles \emph{zero}
\texttt{OneDim/*} modules, with both tiers consuming only the
shared \texttt{Cover}, \texttt{Witness}, and
\texttt{Common.NearCritical} infrastructure.}
\end{remark}
